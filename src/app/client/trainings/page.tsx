...
export default async function ScheduledTrainingsPage() {
  ...
  const renderProgramCard = (
    ...
    return (
      <Card
        key={id}
        className={isToday ? "border-blue-200 bg-blue-50/30" : ""}
      >
        <CardContent className="p-4">
          <div className="flex items-start justify-between gap-4">
            ...
            <Link href={`/client/programs/${clientProgram.id}`}>
              <Button className={isToday ? "bg-blue-600 hover:bg-blue-700" : ""}>
  ...
  return (
    <div className="p-4 md:p-6 max-w-4xl mx-auto">
      <div className="mb-6">
        <h1 className="text-xl md:text-2xl font-bold">Geplande trainingen</h1>
      ...
      {scheduledPrograms.length === 0 && (
        <Card className="mt-6">
          <CardContent className="p-8 text-center">
            ...
            <Link href="/client/programs">
              <Button>Bekijk mijn programma&apos;s</Button>
            </Link>
          </CardContent>
        </Card>
      )}
