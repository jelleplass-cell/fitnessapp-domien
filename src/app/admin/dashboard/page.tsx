      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-3xl shadow-sm p-6">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-base md:text-lg font-semibold text-gray-900">Recente gebruikers</h2>
        ...
        {/* Recent Sessions */}
        <div className="bg-white rounded-3xl shadow-sm p-6">
          <h2 className="text-base md:text-lg font-semibold text-gray-900 mb-4">Recente trainingen</h2>
